...
| 07 | [RDB、multi-part AOF 与混合持久化](07-persistence.md) |
| 08 | [PSYNC 复制](08-replication.md) |
| 09 | [Redis Cluster：slot、MOVED/ASK、gossip](09-cluster.md) |
| 10 | [差分测试：如何验证「逐字节一致」](10-diff-testing.md) |
